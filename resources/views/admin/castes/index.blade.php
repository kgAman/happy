...
@section('title', 'Caste Master - HappilyWeds')
...
<div class="container-fluid py-5 page-spacing font-sans" style="max-width: 1000px;">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3 animate-card">
        <div>
            <h2 class="font-serif fw-bold m-0 text-gradient" style="font-size: 2.5rem;">Caste Master</h2>
            <p class="text-muted mt-2 mb-0" style="font-size: 1rem; font-weight: 500;">Manage the community and caste options available for profiles.</p>
        </div>
    </div>
    ...
    <div class="premium-card p-4 mb-5 animate-card delay-1">
        <form method="POST" action="{{ route('admin.castes.store') }}">
            ...
            <div class="row g-3 align-items-end">
                <div class="col-md-9">
                    <label class="premium-label">Caste Name</label>
                    <div class="position-relative">
                        <i class="bi bi-diagram-3 position-absolute text-muted fs-5" style="left: 15px; top: 12px;"></i>
                        <input type="text" name="caste" class="form-control premium-input w-100" style="padding-left: 45px;" placeholder="e.g. Brahmin, Rajput, Patel" required>
                    </div>
                </div>
                <div class="col-md-3">
                    <button type="submit" class="btn-glow w-100 d-flex justify-content-center align-items-center" style="height: 48px;">
                        <i class="bi bi-plus-lg me-2"></i> Add Caste
                    </button>
                </div>
            </div>
        </form>
                    ...
                    @forelse($data as $row)
                        <tr>
                            ...
                            <td class="text-end pe-4">
                                <form action="{{ route('admin.castes.destroy', $row->id) }}" method="POST" class="m-0 p-0" onsubmit="return confirm('Are you sure you want to delete this caste entry?')">
                                    @csrf 
                                    @method('DELETE')
                                    <button type="submit" class="action-icon-btn delete" title="Delete Caste">
                        ...
                        <tr>
                            <td colspan="4" class="text-center py-5 bg-transparent shadow-none border-0">
                                <div class="d-flex flex-column align-items-center justify-content-center py-4">
                                    ...
                                    <h4 class="font-serif fw-bold text-dark">No Castes Found</h4>
                                    <p class="text-muted fw-medium fs-6">Use the form above to add your first caste option.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
