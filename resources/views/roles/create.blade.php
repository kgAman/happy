...
@section('title', 'Create New Role - HappilyWeds')
...
<div class="container-fluid py-5 page-spacing font-sans">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-5 gap-3 animate-card">
        <div>
            <h2 class="font-serif fw-bold m-0 text-gradient" style="font-size: 2.5rem;">Create New Role</h2>
            <p class="text-muted mt-2 mb-0" style="font-size: 1rem; font-weight: 500;">Define a custom administrative role and assign its capabilities.</p>
        </div>
    </div>
        ...
        <form method="POST" action="{{ route('admin.roles.store') }}">
            ...
            <div class="mb-5">
                ...
                <div class="position-relative">
                    ...
                    <input type="text" name="name" class="form-control premium-input w-100" style="padding-left: 45px;" placeholder="e.g. Super Admin, Moderator, Editor" required>
                </div>
            </div>
            ...
            <div class="mb-5">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <small class="text-muted fw-semibold">Toggle the switches to grant access.</small>
                </div>
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-between gap-3 pt-4 border-top">
                ...
                <button type="submit" class="btn-glow order-1 order-sm-2">
                    Create Custom Role <i class="bi bi-check2-circle ms-2"></i>
                </button>
            </div>
