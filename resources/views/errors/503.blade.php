...
<div class="error-wrapper">
    <div class="error-glass-card" data-number="503">
        <h1 class="error-code">503</h1>
        <h2 class="error-title">Platform Upgrade</h2>
        <p class="error-desc">
            HappilyWeds is currently undergoing scheduled maintenance to improve your matchmaking experience. We will be back online shortly!
        </p>
