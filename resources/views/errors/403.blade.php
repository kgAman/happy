...
@section('title', 'Access Denied | HappilyWeds')
...
<style>
    ...
    .navbar .nav-link, .navbar .navbar-brand, .navbar .navbar-toggler-icon, .navbar .btn {
...
<div class="error-wrapper">
    <div class="error-glass-card" data-number="403">
        <h1 class="error-code">403</h1>
        <h2 class="error-title">Access Restricted</h2>
        <p class="error-desc">
            This area is reserved for premium members or specific profiles. You do not currently have permission to view this page. Let's head back to safe territory.
        </p>
        
        <a href="{{ url('/search') }}" class="btn-action-solid">
            <i class="bi bi-search"></i> Return to Directory
        </a>
    </div>
</div>
