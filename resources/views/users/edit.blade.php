...
@section('title', 'Edit User - HappilyWeds')
...
<style>
    ...
    /* Style the dropdown options (Supported in modern Chrome/Edge) */
...
<div class="container py-5 page-spacing font-sans" style="max-width: 800px;">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-5 gap-3 animate-card">
        <div>
            <h2 class="font-serif fw-bold m-0 text-gradient" style="font-size: 2.5rem;">Edit User Access</h2>
            <p class="text-muted mt-2 mb-0" style="font-size: 1rem; font-weight: 500;">Update administrator details and system roles.</p>
        </div>
    </div>
    ...
    <div class="premium-card p-4 p-lg-5 animate-card delay-1">
        ...
        <div class="d-flex align-items-center mb-4 pb-3 border-bottom">
            ...
            <h4 class="font-serif fw-bold mb-0 text-dark">User Credentials</h4>
        </div>
        ...
        <form method="POST" action="{{ route('admin.users.update', $user) }}">
            ...
            <div class="mb-4">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control premium-input" name="name" value="{{ $user->name }}" placeholder="Enter full name" required>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="input-group">
                    ...
                    <input type="email" class="form-control premium-input" name="email" value="{{ $user->email }}" placeholder="admin@happilyweds.com" required>
                </div>
            </div>
                ...
                <div class="input-group">
                    ...
                    <select name="role_id" class="form-select premium-input" required>
                        @foreach($roles as $id => $r)
                            <option value="{{ $id }}" {{ $user->hasRole($r) ? 'selected' : '' }}>
                                {{ $r }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-between gap-3 pt-4 border-top">
                ...
                <button type="submit" class="btn-glow order-1 order-sm-2">
                    Update User Details <i class="bi bi-check2-circle ms-2"></i>
                </button>
            </div>
