...
<div class="error-wrapper">
    <div class="error-glass-card" data-number="419">
        <h1 class="error-code">419</h1>
        <h2 class="error-title">Session Expired</h2>
        <p class="error-desc">
            Your connection to the matchmaking server has timed out due to inactivity. Don't worry, your potential matches are still waiting for you.
        </p>
        
        <a href="javascript:window.location.reload(true)" class="btn-action-solid">
