...
@section('title', 'Server Error | HappilyWeds')
...
<div class="error-wrapper">
    <div class="error-glass-card" data-number="500">
        <h1 class="error-code">500</h1>
        <h2 class="error-title">Oops! Server Error</h2>
        <p class="error-desc">
            Someone spilled champagne on our servers. Our technical team is cleaning it up right now. Please try again in a few moments.
        </p>
        
        <a href="javascript:history.back()" class="btn-action-solid">
            <i class="bi bi-arrow-counterclockwise"></i> Refresh Page
        </a>
    </div>
</div>
